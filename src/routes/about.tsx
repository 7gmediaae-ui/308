...
export const Route = createFileRoute("/about")({
  head: () =>
    buildHead({
      ...
      title: "من نحن | منصة تجاوب - توثيق شكاوى المستهلكين في الإمارات",
      
      // 2. وصف جذاب ومحدد ضمن حدود 150-160 حرف لنتائج جوجل
      description:
        "تعرّف على منصة تجاوب - المنصة المستقلة لتوثيق شكاوى المستهلكين في الإمارات: رؤيتنا ومهمتنا في توثيق شكاوى المستهلكين وحمايتهم وتوفير مساحة آمنة لإيصال صوتهم للشركات الخاصة.",
