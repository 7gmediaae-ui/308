...
export const Route = createFileRoute("/privacy")({
  head: () =>
    buildHead({
      ...
      title: "سياسة الخصوصية | منصة تجاوب",

      // 2. وصف دقيق وشامل لنتائج البحث
      description:
        "تعرّف على سياسة الخصوصية وحماية البيانات في منصة تجاوب: آلية جمع واستخدام وحماية بيانات المستخدمين وحقوق الخصوصية الخاصة بك.",
