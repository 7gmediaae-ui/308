...
export const Route = createFileRoute("/terms")({
  head: () =>
    buildHead({
      ...
      title: "الشروط والأحكام | منصة تجاوب",

      // 2. وصف شامل ومحسّن لنتائج جوجل
      description:
        "الشروط والأحكام الخاصة بـ منصة تجاوب: توضيح طبيعة الخدمة المستقلة، حدود المسؤولية، وحقوق واستخدام المستهلك.",
    ...
    <>
      ...
      <article className="container-page prose prose-neutral mx-auto max-w-3xl py-14 leading-8">
        ...
        <p className="mt-2 text-muted-foreground">
          منصة تجاوب هي منصة خاصة ومستقلة تمامًا، غير تابعة لأي جهة حكومية في دولة الإمارات
