...
export const Route = createFileRoute("/how-it-works")({
  head: () =>
    buildHead({
      ...
      title: "كيف تعمل المنصة | منصة تجاوب",

      // 2. وصف جذاب ومحدد يتضمن المراحل الأساسية للخدمة
      description:
        "تعرف على كيفية تقديم وتوثيق الشكاوى عبر منصة تجاوب خطوة بخطوة: من تعبئة النموذج وحتى متابعة الرد واستلام الإشعارات.",
      ...
      jsonLd: {
        ...
        "@type": "HowTo",
        name: "طريقة تقديم وتوثيق شكوى عبر منصة تجاوب",
