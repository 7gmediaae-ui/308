...
export const Route = createFileRoute("/")({
  head: () => {
    const baseHead = buildHead({
      title: "منصة تجاوب | تقديم وتوثيق شكاوى المستهلك ضد الشركات الخاصة",
      description:
        "هل واجهت مشكلة تجارية؟ قدّم شكواك ورسالتك الآن عبر منصة تجاوب لتوثيق ومتابعة شكاوى المستهلكين ضد المنشآت والشركات الخاصة في الإمارات بسهولة وشفافية.",
      path: "/",
      jsonLd: [
        {
        ...
        },
        {
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات تجاوب والحلول التجارية",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
