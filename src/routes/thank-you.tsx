...
export const Route = createFileRoute("/thank-you")({
  head: () =>
    buildHead({
      title: "تم استلام شكواك بنجاح | منصة تجاوب",
      description:
        "شكرًا لتقديم شكواك عبر منصة تجاوب تم استلام الطلب وبدأت عملية المراجعة.",
      path: "/thank-you",
    }),
        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-muted-foreground md:text-lg">
              شكرًا لثقتك بـ{" "}
              <span className="font-bold text-accent">منصة تجاوب</span>
